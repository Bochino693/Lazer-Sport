...
def classificar_imagens_existentes(apps, schema_editor):
    """
    Preserva os arquivos existentes.

    As três primeiras imagens de cada brinquedo passam a ter um tipo:
      1 -> perfil (capa)
      2 -> verso
      3 -> lado direito

    Galerias antigas com mais de três imagens NÃO são apagadas pela migration.
    As fotos excedentes ficam sem tipo e deixam de participar da galeria
    pública/admin moderna até que o brinquedo seja revisado.
    """
